...
> ⚠️ **Warning:** At the moment, this tool requires downloading a dynamic library to function. The library is open
> source and can be found [here](https://github.com/blkmlk/memtrace-lib).
